...
@Slf4j
public class YamlHelperConfiguration {
    ...
    public YamlHelperConfiguration(LoadSettings loadSettings, String yamlContent) {
        this.loadSettings = loadSettings;
        this.yamlContent = yamlContent;
    }

    // Constructor that reads YAML from a file path
    public YamlHelperConfiguration(Path originalFilePath) throws IOException {
     ...
     */
    public boolean updateValuesFromYaml(
            YamlHelperConfiguration sourceYaml, YamlHelperConfiguration targetYaml) {
