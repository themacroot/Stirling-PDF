...
import stirling.software.spdf.proprietary.security.configuration.YamlHelperConfiguration;
...
public class GeneralUtil {
    ...
    public static void saveKeyToSettings(String key, Object newValue) throws IOException {
        ...
        Path settingsPath = Paths.get(InstallationPathConfiguration.getSettingsPath());
        YamlHelperConfiguration settingsYaml = new YamlHelperConfiguration(settingsPath);
